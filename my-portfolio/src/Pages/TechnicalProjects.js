...
const TechnicalProjects = ({ props }) => {
	return (
		<>
			<section className="technical-header-container">
				<h1 className=" technical-title underline">
			...
			<div className="technical-projects-main">
				<div className="project one">
					...
					></iframe>
					<p>
						<b>Cold Cats</b> is a single player, platform, survival game. You
						play as a cold kitty named Fuligin. Who got separated from his
						loving owner. Your objective is to make sure Fuligin gets food to
						keep his hunger bar full, while also going near objects that emit
						warmth to fill your warmth bar.
					</p>
				...
				<div className="project one">
					...
					/>
					<p>
						<b> DIY Craft Kits</b>, a branch Of Maker House. Initially founded
						in 2015, Maker House’s mission is to bring the maker movement to
						main street retail.
					</p>
